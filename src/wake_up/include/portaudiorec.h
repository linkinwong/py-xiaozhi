/*
 * @file
 * @brief a record demo using PortAudio
 *
 * a simple record code. using PortAudio APIs.
 * keep the function same as linuxrec.h
 *
 * Common steps:
 *	create_recorder,
 *	open_recorder, 
...
#ifndef __IFLY_PORTAUDIOREC_H__
#define __IFLY_PORTAUDIOREC_H__
...
struct recorder {
	...
	void * wavein_hdl;      /* PortAudio stream handle */
	pthread_t rec_thread;   /* thread id */
 ...
 *
 * @return	returns default device ID
 *
 */
